    ...
    case 'running':
      return (
        <Svg width={size} height={size} viewBox="0 0 24 24">
          ...
          <Path
            d="M5 20l4-6 3 2 4-3-2-4-4 1-3 4"
            stroke={stroke}
            strokeWidth={sw}
            strokeLinecap={lc}
            strokeLinejoin={lj}
    ...
    case 'chart':
      return (
        <Svg width={size} height={size} viewBox="0 0 24 24">
          ...
          <Path
            d="M6 16V9M11 16V5M16 16v-7M21 16v-3"
            stroke={stroke}
            strokeWidth={sw}
            strokeLinecap={lc}
          />
    ...
    case 'link':
      return (
        <Svg width={size} height={size} viewBox="0 0 24 24">
          ...
          />
          <Path
            d="M14 10a4 4 0 00-5.66 0l-3 3a4 4 0 005.66 5.66L13 17"
            stroke={stroke}
            strokeWidth={sw}
            strokeLinecap={lc}
            fill="none"
    ...
    case 'settings':
      return (
        <Svg width={size} height={size} viewBox="0 0 24 24">
          ...
          <Path
            d="M19 12a7 7 0 00-.1-1.2l2-1.5-2-3.5-2.4.9a7 7 0 00-2-1.2L14 3h-4l-.5 2.5a7 7 0 00-2 1.2L5 5.8 3 9.3l2 1.5a7 7 0 000 2.4L3 14.7l2 3.5 2.4-.9a7 7 0 002 1.2L10 21h4l.5-2.5a7 7 0 002-1.2l2.4.9 2-3.5-2-1.5c.07-.4.1-.8.1-1.2z"
            stroke={stroke}
            strokeWidth={sw}
            strokeLinejoin={lj}
            fill="none"
