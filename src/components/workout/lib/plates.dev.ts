...
check('100 kg → 25+15 per side', r1.plates.length === 2 && r1.totalKg === 100 && r1.warning === null);
...
check('21 kg exact with 0.5 plates', r4.totalKg === 21 && r4.plates[0].size === 0.5 && r4.warning === null);
...
// 7. format
check('format', formatPlateList([{ size: 25, count: 2 }, { size: 10, count: 1 }]) === '2×25 · 1×10');
...
check('60 kg → 1×20', r8.plates.length === 1 && r8.plates[0].size === 20 && r8.plates[0].count === 1);
