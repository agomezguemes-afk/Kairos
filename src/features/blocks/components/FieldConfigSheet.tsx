...
const FIELD_CATALOG: FieldCatalogEntry[] = [
  ...
  },
  {
    ...
    icon: 'repeat',
    category: 'Fuerza',
    disciplines: ['strength', 'calisthenics', 'general'],
    step: 1,
    min: 1,
  },
  {
  ...
  },
  {
    ...
    icon: 'clock',
    category: 'Cardio',
    disciplines: ['running', 'cycling', 'swimming', 'mobility', 'team_sport', 'general'],
    step: 1,
  },
  {
    id: 'pace',
  ...
  },
  {
    ...
    icon: 'heart',
    category: 'Cardio',
    disciplines: ['running', 'cycling', 'swimming', 'team_sport'],
    step: 1,
  },
  {
    id: 'calories',
    ...
    icon: 'zap',
    category: 'General',
    disciplines: ['running', 'cycling', 'swimming', 'team_sport', 'general'],
    step: 10,
  },
  {
    id: 'perceivedEffort',
    name: 'Esfuerzo percibido',
    type: 'number',
    unit: '/10',
    icon: 'activity',
    category: 'General',
    disciplines: ['mobility', 'team_sport', 'general'],
    min: 1,
    max: 10,
  },
  {
...
export default function FieldConfigSheet({
  visible,
  fields,
  discipline,
  onSave,
  ...
  const addFieldFromCatalog = useCallback(
            ...
            <View style={styles.header}>
              <View>
                ...
                <Text style={styles.subtitle}>
                  {disciplineName} · {localFields.length} campos
                </Text>
              </View>
              ...
              {localFields.map((field, idx) => (
                ...
                >
                  ...
                  <View style={styles.fieldActions}>
                    <Pressable
                      onPress={() => togglePrimary(field.id)}
                      hitSlop={6}
                    ...
                    >
                      <Feather
                        name="star"
                        size={14}
                        color={field.isPrimary ? Colors.accent.primary : Colors.text.disabled}
                      />
                    </Pressable>
                    {idx > 0 && (
                      <Pressable
              ...
              {relevantCatalog.relevant.length > 0 && (
                <>
                  <Text style={styles.sectionLabel}>
                    RECOMENDADOS PARA {disciplineName.toUpperCase()}
                  </Text>
                  ...
                  <View style={styles.chipGrid}>
                    {relevantCatalog.other.map((entry) => (
                      ...
                      >
                        ...
                        <Text style={[styles.addChipText, { color: Colors.text.secondary }]}>
                          {entry.name}
                        </Text>
                      </Pressable>
                    ))}
                ...
                <View style={styles.customForm}>
                      ...
                      {(['number', 'text'] as FieldType[]).map((t) => (
                        ...
                        >
                          <Text
                            style={[
                              styles.typeBtnText,
                              customType === t && styles.typeBtnTextActive,
                            ]}
                          >
                            {t === 'number' ? '#' : 'Aa'}
                          </Text>
                  ...
                  <View style={styles.customActions}>
                    ...
                    <Pressable
                      ...
                      style={[styles.customAdd, !customName.trim() && { opacity: 0.4 }]}
                    >
