...
const STRENGTH: ExerciseLibraryEntry[] = [
  ...
  // Core
  {
    ...
    defaultSetsCount: 3,
    defaultRestSeconds: 45,
    fields: timeBasedField(),
  },
  {
    id: 'lib-hanging-leg-raise',
    name: 'Elevaciones piernas colgado',
    discipline: 'strength',
    muscleGroups: ['core'],
    icon: 'zap',
    defaultSetsCount: 3,
...
const CARDIO: ExerciseLibraryEntry[] = [
  {
    ...
    discipline: 'running',
    muscleGroups: ['cardio_engine', 'quads', 'calves'],
    icon: 'running',
    defaultSetsCount: 1,
    defaultRestSeconds: 0,
    fields: distanceTimeFields(),
  },
  {
    id: 'lib-run-intervals',
    name: 'Intervalos',
    discipline: 'running',
    muscleGroups: ['cardio_engine', 'quads'],
    icon: 'running',
    defaultSetsCount: 8,
    defaultRestSeconds: 90,
    fields: distanceTimeFields(),
  ...
  },
  {
    ...
    name: 'Largos piscina',
    discipline: 'swimming',
    muscleGroups: ['cardio_engine', 'back', 'shoulders'],
    icon: 'running',
    defaultSetsCount: 1,
    defaultRestSeconds: 0,
    fields: distanceTimeFields(),
  },
  {
    ...
    name: 'Comba',
    discipline: 'general',
    muscleGroups: ['cardio_engine', 'calves'],
    icon: 'zap',
    defaultSetsCount: 3,
    defaultRestSeconds: 60,
    fields: timeBasedField(),
...
const MOBILITY: ExerciseLibraryEntry[] = [
  ...
  {
    id: 'lib-shoulder-dislocates',
    name: 'Dislocaciones hombro',
    discipline: 'mobility',
